...
numberButtons.forEach((numberBtn) => {
  numberBtn.addEventListener("click", () => {
    ...
    if (
      ...
      main.textContent == "Negative number"
    ) {
      firstNumber = value;
      main.textContent = firstNumber;
    } else {
  ...
  basicOperatorBtn.addEventListener("click", () => {
    if (
      ...
      if (secondNumber == "") {
        ...
        operatorDisplay.textContent =
          basicOperatorBtn.getAttribute("data-value");
        firstNumber = 0;
        main.textContent = firstNumber;
        secondary.textContent = secondNumber;
...
document.addEventListener("keydown", function (event) {
  if (event.key >= "0" && event.key <= "9") {
    ...
    if (
      ...
      if (secondNumber == "") {
        secondNumber = firstNumber;
        operatorDisplay.textContent = String.fromCharCode(8722);
        firstNumber = 0;
        main.textContent = firstNumber;
        secondary.textContent = secondNumber;
    ...
    if (
      ...
      if (secondNumber == "") {
        secondNumber = firstNumber;
        operatorDisplay.textContent = String.fromCharCode(42);
        firstNumber = 0;
        main.textContent = firstNumber;
        secondary.textContent = secondNumber;
